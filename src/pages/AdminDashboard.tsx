                                            ...
                                            <div key={g.id} className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-xl shadow-sm">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-2 mt-2">
                                                        ...
                                                        <span className={`text-[10px] px-2 py-1 rounded font-bold border flex items-center gap-1 ${assignedCpCount > 0 ? 'bg-blue-50 text-blue-700 border-blue-200' : 'bg-red-50 text-red-600 border-red-200'}`}>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 mt-8">
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                {siteGuards.filter(g => g.is_clocked_in).map(g => {
                                    ...
                                    return (
                                        <div key={g.id} className={`p-4 rounded-xl border-2 transition-all ${isAtRisk ? 'bg-red-50 border-red-500 shadow-[0_0_15px_rgba(239,68,68,0.2)]' : 'bg-gray-50 border-gray-200'}`}>
                                            ...
                                            <div className="space-y-1">
                                                <p className="text-xs text-gray-500 font-bold uppercase">Latest Activity:</p>
                                                {lastScan ? (
                                                    <p className="text-sm font-semibold text-gray-800">Scanned Checkpoint ID: {lastScan.checkpoint_id.substring(0, 6)}</p>
                                                ) : (
